...
from my_models import misc_functions
...
class CamExtractor():
    ...
    def forward_pass_on_convolutions(self, x):
        ...
        """
        conv_output, count = None, 0
        for _, module in self.model.img_encoder.backbone._modules.items():
            x = module(x.squeeze())  # Forward
